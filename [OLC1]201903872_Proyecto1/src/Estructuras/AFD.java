...
public class AFD {
    ...
    public void GRAFICARARBOL(){
        this.num = 1;
        File directorio = new File("./ARBOLES_201903872");
        ...
        try
        {
            fichero = new FileWriter("./ARBOLES_201903872/"+nombre+".dot");
            ...
            rt.exec( "dot -Tjpg -o ./ARBOLES_201903872/"+nombre+".jpg graf ./ARBOLES_201903872/"+nombre+".dot");
        }catch(IOException e){
    ...
    public void GRAFICARSIGUIENTES(){
        File directorio = new File("./SIGUIENTES_201903872");
        if (!directorio.exists()) {
            directorio.mkdirs();
        }
        FileWriter fichero;
        ...
        try
        {
            fichero = new FileWriter("./SIGUIENTES_201903872/"+nombre+".dot");
            escritor = new PrintWriter(fichero);
            escritor.print("digraph grafica{\n"
                + "rankdir=LR;\n"
                + "forcelabels= true;\n"
            ...
            fichero.close();
            Runtime rt = Runtime.getRuntime();
            rt.exec( "dot -Tjpg -o ./SIGUIENTES_201903872/"+nombre+".jpg graf ./SIGUIENTES_201903872/"+nombre+".dot");
        }catch(IOException e){
            System.out.println("error al crear la grafica");
        }  
    }
    ...
    public void GraficarAFD(){
        File directorio = new File("./AFD_201903872");
        if (!directorio.exists()) {
            directorio.mkdirs();
        }
        FileWriter fichero;
        ...
        try
        {
            fichero = new FileWriter("./AFD_201903872/"+nombre+".dot");
            escritor = new PrintWriter(fichero);
            escritor.print("digraph grafica{\n"
                + "rankdir=LR;\n"
                + "forcelabels= true;\n"
            ...
            fichero.close();
            Runtime rt = Runtime.getRuntime();
            rt.exec( "dot -Tjpg -o ./AFD_201903872/"+nombre+".jpg graf ./AFD_201903872/"+nombre+".dot");
        }catch(IOException e){
            System.out.println("error al crear la grafica");
        }
    }
