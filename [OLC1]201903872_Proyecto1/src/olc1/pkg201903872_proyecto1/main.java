...
public class main extends javax.swing.JFrame {
    ...
    static FileNameExtensionFilter filtro = new FileNameExtensionFilter(" Archivo .olc", "olc","OLC","Olc");
    ...
    private void initComponents() {
        ...
        file_name.setText("File name: Nuevo Archivo.olc");
        ...
        tipo.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Arbol", "Siguientes", "Transiciones", "AFD", "AFND" }));
        ...
        try {            
            ...
            if (option == JFileChooser.APPROVE_OPTION) {
                ...
                if (!name.endsWith("olc")) {
                    archivo = new File(file.getSelectedFile().getAbsolutePath()+".olc");
